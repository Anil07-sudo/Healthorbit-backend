...
// helper  function
// this  function will convert time12 hrs to number of minutes sinces midnight;
...
// this function will remove  duplicate slot and return the slot fileter by time
...
// this fun ction accept the obj to json
...
export async function deleteDoctor(req,res){
  try{
    ...
    console.error("delteDoctor error :",err);
    return res.status(500).json({
      success: false,
      message:"Server Error"
    })
